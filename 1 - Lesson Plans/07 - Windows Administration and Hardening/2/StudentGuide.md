...
- [Activity File: Move and Create Directories](Activities/3 - Move and Create Dir/Unsolved/Readme.md)
...
- [Activity File: Removing Unnnecessary Packages with Powershell Scripts](Activities/9 - Removing Packages/Unsolved/Readme.md)
- [Choco Activity File](Activities/9 - Removing Packages/chocoactivity.csv) 
- [Syntax Reference and Helpful Hints](./Activities/9 - Removing Packages/tips.md)
